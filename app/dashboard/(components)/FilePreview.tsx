...
function FilePreview({ file, removeFile }: { file: any, removeFile: () => void }) {
    return (
        <div className='flex items-center gap-2 justify-between mt-5 border rounded p-2 border-blue-100'>
