  ...
  return (
    ...
    >
      <div className="backdrop-filter-[12px] inline-flex h-7 items-center justify-between rounded-full border border-white/5 bg-white/10 px-3 text-xs text-white dark:text-black transition-all ease-in hover:cursor-pointer hover:bg-white/20 group gap-1 translate-y-[-1rem] animate-fade-in opacity-0">
        ...
        <a href="https://emoji.gg/emoji/1676_blue_sparkles"><img src="https://cdn3.emoji.gg/emojis/1676_blue_sparkles.png" width="13px" height="13px" alt="blue_sparkles"></img></a>
      ...
      <h1 className="bg-gradient-to-br dark:from-white from-black from-30% dark:to-white/40 to-black/40 bg-clip-text py-6 text-5xl font-medium leading-none tracking-tighter text-transparent text-balance sm:text-6xl md:text-7xl lg:text-8xl translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
       <strong>ComplaintSense</strong> 
        <br className="hidden md:block" />  makes complaint management effortless.
      </h1>
      <p className="mb-12 text-lg tracking-tight text-gray-400 md:text-xl text-balance translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms]">
      Efficiently handle and prioritize complaints with AI-driven tools
        <br className="hidden md:block" /> or text, voice**, image, and video** inputs.
      </p>
